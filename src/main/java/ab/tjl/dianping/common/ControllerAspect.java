...
import ab.tjl.dianping.controller.admin.AdminController;
...
/**
 * @Author:TangJiLin
 * @Description:切面处理事务 防止其他用户直接闯入后台界面
 * @Date: Created in 2020/2/7 11:13
 * @Modified By:
 */
@Aspect
@Configuration
public class ControllerAspect {
    ...
    /**
     * 环绕切面通知 只要admin包下面的被打上requestMapping的标志的方法都会被打入切面
     * @param joinPoint
     * @return
     * @throws Throwable
     */
    @Around("execution(* ab.tjl.dianping.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
